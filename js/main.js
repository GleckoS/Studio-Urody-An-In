...
const sliderData = [
    {
        title: "FRYZJERSTWO",
        text: "Wykształcone fryzjery i kosmetyka CHI, zadbają o waszych włosach.",
        id: "#fryzjer"
    },
    {
        title: "MANICURE",
        text: "Nasza stylistka paznokci wie, jak dobrze zaaplikować kazdy rodzaj zdobień czy stępli.",
        id: "#manicure"
    },
    {
        title: "PRZEDŁUŻANIE",
        text: "Chcesz mieć długi i gęste rzęsy? Zapraszamy! Twoje rzęsy będę fantastycznie!",
        id: "#przedluzanie"
    },
    {
        title: "DEPILACJA CUKROWA",
        text: "Podczas zabiegu robimy wszystko, by ból był jak najmniejszy!",
        id: "#depilacja"
    },
    {
        title: "MASAŻ",
        text: "Nasza profesjonalna masażystka likwiduje stres, ból i nadwagi.",
        id: "#masaz"
    },
    {
        title: "TATUAŻ",
        text: "Żeby oszczędnic swój czas na porannim makijażu, zrób makijaż permanentny!",
        id: "#tatuaz"
    },
    {
        title: "DEPILACJA LASEROWA",
        text: "Gładkie ciało bez włosów przez długi czas jest możliwe dzięki naszemu laserowi.",
        id: "#laser"
    },
    {
        title: "KOSMETOLOGIA",
        text: "Używamy kosmetyków z wyższej półki. Trafisz pod profesjonalne ręce.",
        id: "#kosmetologia"
    },
]
...
sliderData.map(item => {
    ...
    <div class="services__item">
                <img alt="" class="about__img" src="img/services-9.png">
                ...
                <div class="services__item-btn">
                    <button class="learn-more">
                        ...
                        <span class="button-text"><a title="więcej" class="button-text" data-fancybox
                                                     data-src=${item.id} href="javascript:">
                        Więcej</a></span>
                    </button>
                </div>
            </div>
    `
    let doc = new DOMParser().parseFromString(str, 'text/xml')
    document.getElementById("slider").append(doc.firstChild)
})*/
